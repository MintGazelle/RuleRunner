...
GAMES["terraforming-mars"] = {
    ...
    howToPlay: [
      { heading:"Objective", text:"You run a corporation racing to terraform Mars into a habitable planet, competing to end the game with the most Victory Points from your Terraforming Rating, cards, and board presence." },
      { heading:"Setup", text:"Each player picks or drafts a Corporation card, which sets your starting resources and a permanent ability. Deal each player a hand of Project cards, and set the global parameter trackers (Temperature, Oxygen, Oceans) to their starting values." },
      { heading:"Turn Structure", text:"Each generation opens with a Research phase where players draft or buy cards, then an Action phase where players take turns doing one or two actions until everyone has passed, then a Production phase." },
      { heading:"Winning", text:"The game ends once Temperature, Oxygen, and Oceans have all reached maximum. Finish that generation, do one last Production phase, then total up your Terraforming Rating, card points, Milestones, Awards, and tile adjacency to find the winner." },
      { heading:"Quick Tip", text:"Watch a card's requirement before you commit resources toward playing it — many cards need a specific global parameter threshold, and timing when you play them matters as much as which cards you pick." },
    ],
    rules: [
