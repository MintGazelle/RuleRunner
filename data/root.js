...
GAMES["root"] = {
    ...
    howToPlay: [
      { heading:"Objective", text:"Each faction pursues victory through a completely different engine. The first faction to reach 30 points triggers the end of the game at the end of that round." },
      { heading:"Setup", text:"Lay out the map (the standard side has 12 clearings in Fox, Rabbit, and Mouse suits), shuffle the shared card deck, and set every faction's score marker to 0. Each faction then does its own unique setup — the Marquise de Cat starts with buildings and warriors already spread across the board, the Eyrie Dynasties starts with a Leader and a Roost, the Woodland Alliance starts with almost nothing on the board but a full box of Sympathy tokens, and the Vagabond starts alone in the forest with a small item loadout. Turn order is set once at the start and never rotates." },
      { heading:"Your Turn", text:"Three steps every turn: Birdsong (a mandatory faction-specific setup step — the Eyrie must add to their Decree here, for instance), Daylight (your main step — take any combination of Move, Battle, Recruit/Build, Overwork, and Craft that your faction sheet allows and you can afford), and Evening (draw cards, then discard down to your hand limit of 5 if you're over)." },
      { heading:"What Each Faction Is Going For", text:"Marquise de Cat scores from buildings and crafted cards. Eyrie Dynasties scores from a rigid Decree they must fully execute each turn or suffer Turmoil. Woodland Alliance builds Sympathy across the board and scores by converting sympathetic clearings into bases. Vagabond scores through quests and battles, acting alone rather than controlling territory." },
      { heading:"Winning", text:"Reaching 30 points ends the game at the end of that round; highest score wins. Dominance cards offer an alternate win condition for whoever plays one and meets its criteria, and in 4+ player games the Vagabond can win by forming a Coalition with the lowest-scoring player instead of scoring points themselves." },
