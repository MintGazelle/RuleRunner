...
GAMES["carcassonne"] = {
  ...
  howToPlay: [
    { heading:"Objective", text:"Build a landscape of roads, cities, cloisters, and farms out of tiles, and score the most points from the features your followers control." },
    { heading:"Setup", text:"Shuffle all the land tiles face-down, place the starting tile face-up on the table, and give each player 7 followers (plus one large follower each too, if playing with Inns & Cathedrals)." },
    { heading:"Your Turn", text:"Draw one tile and place it adjacent to the existing layout so every edge you touch matches (road to road, city to city, field to field). If it can't legally go anywhere, discard it and draw again. Then, optionally, place one follower from your supply onto that same tile — as a Knight in a city, Thief on a road, Monk in a cloister, or Farmer in a field — as long as that feature doesn't already have someone else's follower on it." },
    { heading:"Scoring", text:"Roads score 1 point per tile the instant both ends are closed off. Cities score 2 points per tile plus 2 per shield, scored the instant the last gap closes. Cloisters score 9 points (1 for itself, 1 per surrounding tile) once all 8 neighboring spaces are filled. All three return your follower to your supply immediately. Farms never score during play — only at the very end, worth 3 points per completed city each farm touches." },
    { heading:"Winning", text:"The game ends the moment the last tile is drawn and placed. Score any remaining incomplete features at reduced value, then farms, and whoever has the most total points wins." },
    { heading:"Quick Tip", text:"Don't commit your followers too early — you only get one back once its feature completes, so an early Knight stuck in a slow-growing city can leave you short-handed for the rest of the game." },
  ],
  rules: [
