...
GAMES["carcassonne"] = {
  ...
  howToPlay: [
    ...
    { heading:"Setup", text:"Shuffle all the land tiles, place the starting tile face-up, and give each player their followers (and a large follower too, if playing with Inns & Cathedrals)." },
    { heading:"Turn Structure", text:"On your turn, draw one tile, place it so every touching edge matches, then optionally place one follower on that same tile onto a feature that doesn't already have one." },
    { heading:"Winning", text:"Roads, cities, and cloisters score immediately when completed. Farms don't score until the very end. Whoever has the most total points once the last tile is placed and final scoring is resolved wins." },
    { heading:"Quick Tip", text:"Don't commit your followers too early — you only get a follower back once its feature completes, so an early Knight stuck in a slow-growing city can leave you short-handed for the rest of the game." },
  ],
  rules: [
